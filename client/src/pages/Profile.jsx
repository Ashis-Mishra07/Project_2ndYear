    ...
    return (
        <div className='p-3 max-w-lg mx-auto'>
            ...
            <div className='flex justify-between mt-5'>
                <span className='text-red-700 cursor-pointer font-semibold text-lg'> Delete Account</span>
                <span className='text-red-700 cursor-pointer font-semibold text-lg'> Sign Out</span>
            </div>
